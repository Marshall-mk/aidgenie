...
def features():
    st.subheader(
        ":blue[Store], :blue[Convert], and :blue[Generate] paired :green[Scans] & :red[Reports] in multiple formats!"
    )
...
def about():
    ...
    st.write(
        """The scarcity of reliable medical data from developing countries, particularly in regions like Nigeria and other parts of Africa, 
...
def mission():
    st.title("Mission")
    st.write(
        """Our mission is to alleviate the shortage of medical data from developing countries by developing a robust platform and data 
...
def vision():
    st.title("Vission")
    st.write(
        """Our vision is to create an inclusive global healthcare landscape where high-quality medical data from developing countries is readily
